"""
Generates DATA.csv from the chriskempson Japanese subtitles word frequency report.
...
INPUT_FILE = os.path.join(os.path.dirname(__file__), "../../CHRISKEMPSON/word_freq_report.txt")

"""
Generates DATA.csv from the Novels Yomitan frequency dictionary (MarvNC/Kuuube).
Source: term_meta_bank_1.json — [word, "freq", rank] (0-indexed rank)
Output: top 25,000 words with WORD, FREQUENCY_RANKING columns (1-indexed).
"""
...
INPUT_FILE = os.path.join(
    ...
    "../../MARVNC/[JA Freq] Novels/term_meta_bank_1.json",
)

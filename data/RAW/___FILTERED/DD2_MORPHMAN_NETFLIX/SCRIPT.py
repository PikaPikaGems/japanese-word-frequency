"""
Generates DATA.csv from Dave Doebrick's Morphman Netflix frequency report.
Source: 'Morphman netflix_unidic_3011_no_names_word_freq_report.txt' — tab-separated Morphman report.
...
INPUT_FILE = os.path.join(os.path.dirname(__file__), "../../DAVE_DOEBRICK_PART2/MORPHMAN/Morphman netflix_unidic_3011_no_names_word_freq_report.txt")

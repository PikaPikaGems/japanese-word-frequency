"""
Generates DATA.csv from the Jiten Audio frequency list CSV.
Source: frequency_list_Audio.csv — columns: Word, Form, Rank
...
INPUT_FILE = os.path.join(os.path.dirname(__file__), "../../JITEN/frequency_list_Audio.csv")

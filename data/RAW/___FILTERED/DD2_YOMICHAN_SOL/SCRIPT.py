"""
Generates DATA.csv from Dave Doebrick's Yomichan Slice of Life Top 100 frequency list.
Source: 'SoL Top 100/term_meta_bank_1.json' — [[word, "freq", rank_int], ...]
...
INPUT_FILE = os.path.join(os.path.dirname(__file__), "../../DAVE_DOEBRICK_PART2/YOMICHAN/SoL Top 100/term_meta_bank_1.json")

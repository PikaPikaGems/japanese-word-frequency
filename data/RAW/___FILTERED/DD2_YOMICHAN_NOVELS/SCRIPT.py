"""
Generates DATA.csv from Dave Doebrick's Yomichan Novel 5k Stars frequency list.
Source: Novel_5k_Top_Stars/term_meta_bank_1.json — [[word, "freq", "★★★★★ (rank)"], ...]
...
INPUT_FILE = os.path.join(os.path.dirname(__file__), "../../DAVE_DOEBRICK_PART2/YOMICHAN/Novel_5k_Top_Stars/term_meta_bank_1.json")

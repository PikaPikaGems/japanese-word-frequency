"""
Generates DATA.csv from the Jiten Global frequency list CSV.
Source: frequency_list_global.csv — columns: Word, Form, Rank
...
INPUT_FILE = os.path.join(os.path.dirname(__file__), "../../JITEN/frequency_list_global.csv")

"""
Generates DATA.csv from the Monodicts 206k Yomitan frequency dictionary (Shoui collection).
Source: term_meta_bank_1.json — [word, "freq", rank]
...
INPUT_FILE = os.path.join(
    ...
    "../../SHOUI/[Freq] Monodicts 206k/term_meta_bank_1.json",
)

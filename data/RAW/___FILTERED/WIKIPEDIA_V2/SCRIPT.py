"""
Generates DATA.csv from the Wikipedia v2 Yomitan frequency dictionary (MarvNC/Shoui collection).
Source: term_meta_bank_1.json — [word, "freq", rank] (integer rank)
...
INPUT_FILE = os.path.join(
    ...
    "../../MARVNC/[JA Freq] Wikipedia v2/term_meta_bank_1.json",
)

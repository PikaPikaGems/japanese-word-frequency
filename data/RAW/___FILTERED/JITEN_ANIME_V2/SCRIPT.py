"""
Generates DATA.csv from the Jiten Anime frequency list CSV.
Source: frequency_list_Anime.csv — columns: Word, Form, Rank
...
INPUT_FILE = os.path.join(os.path.dirname(__file__), "../../JITEN/frequency_list_Anime.csv")

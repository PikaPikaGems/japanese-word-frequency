"""
Generates DATA.csv from the hlorenzi Jisho-open anime/drama word rankings.
Source file: word_rankings_animedrama.txt (one word per line, rank = line number)
...
INPUT_FILE = os.path.join(os.path.dirname(__file__), "../../HLORENZI/word_rankings_animedrama.txt")

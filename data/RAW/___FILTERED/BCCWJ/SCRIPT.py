"""
Generates DATA.csv from the KUUUUBE BCCWJ SUW+LUW combined Yomitan frequency dictionary.
...
INPUT_FILE = os.path.join(
    ...
    "../../KUUUUBE/BCCWJ_SUW_LUW_combined/term_meta_bank_1.json",
)
...
def main():
    ...
    # Sort by rank ascending (rank 1 = most frequent); stable to preserve tie order

"""
Generates DATA.csv from Dave Doebrick's Morphman Shonen frequency report.
Source: 'shounen_instance_freq_report.txt' — tab-separated Morphman report format.
...
INPUT_FILE = os.path.join(os.path.dirname(__file__), "../../DAVE_DOEBRICK_PART2/MORPHMAN/shounen_instance_freq_report.txt")

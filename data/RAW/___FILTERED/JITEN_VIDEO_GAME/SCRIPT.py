"""
Generates DATA.csv from the Jiten VideoGame frequency list CSV.
Source: frequency_list_VideoGame.csv — columns: Word, Form, Rank
...
INPUT_FILE = os.path.join(os.path.dirname(__file__), "../../JITEN/frequency_list_VideoGame.csv")

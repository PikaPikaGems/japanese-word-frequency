"""
Generates DATA.csv from Dave Doebrick's Yomichan Visual Novel Stars frequency list.
Source: VNs_freq_list_Stars/term_meta_bank_1.json — [[word, "freq", "★★★★★ (rank)"], ...]
...
INPUT_FILE = os.path.join(os.path.dirname(__file__), "../../DAVE_DOEBRICK_PART2/YOMICHAN/VNs_freq_list_Stars/term_meta_bank_1.json")

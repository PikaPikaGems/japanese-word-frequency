...
- Your INPUTS
  --> ./data/CEJC/CONSOLIDATED_UNIQUE.csv
...
- Given the input Create a SCRIPT.py that will output ./data/ALL/consolidated.csv
  where the rows are the words as sorted in CONSOLIDATED_UNIQUE.csv
- WORD, RANK_A, RANK_B, RANK_C, ... and so on and so forth given CONSOLIDATED_UNIQUE.csv, and all the DATA.csv in RAW/\_\_\_FILTERED
- Update the ./data/all/README.md accordingly

# Task 2

-- Now that you have ./data/all/consolidated.csv, you will use the data here to create a file ./data/all/categorized.csv . create a script called ./data/ALL/CATEGORIZED.py

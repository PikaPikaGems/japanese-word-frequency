...
> **Column IDs** match column names in `consolidated.csv` and folder names under `data/RAW/___FILTERED/`.
...
| `DD2_MORPHMAN_SOL` | Dave Doebrick 2 | Slice-of-Life anime, Morphman/UniDic format (~45k entries). ✅ **Recommended SOL pick.** |
...
| `JITEN_AUDIO` | ~8,370 | Audio / podcasts *(very small — limited signal only)* |
